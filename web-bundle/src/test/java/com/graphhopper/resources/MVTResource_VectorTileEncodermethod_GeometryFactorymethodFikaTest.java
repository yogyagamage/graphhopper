...
public class MVTResource_VectorTileEncodermethod_GeometryFactorymethodFikaTest {

    @Test
    public void testDoGetXyzTriggersGeometryFactoryConstructor() throws Exception {
        ...
        // Create an empty list of encoded values to avoid NPE
        when(encodingManagerMock.getEncodedValues()).thenReturn(java.util.Collections.emptyList());
        ...
        // We need zInfo <= 9 to trigger the first branch that creates VectorTileEncoder
        mvtResource.doGetXyz(
