...
public class RoadDensityCalculatorcalcRoadDensity_IntSetcontainsFikaTest {
    ...
    public void testCalcRoadDensity() {
        ...
        ToDoubleFunction<EdgeIteratorState> calcRoadFactor = Mockito.mock(ToDoubleFunction.class);
        Mockito.when(calcRoadFactor.applyAsDouble(Mockito.any(EdgeIteratorState.class))).thenReturn(1.0);
